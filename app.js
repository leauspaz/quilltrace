 ...
 * Vanilla JS with per-keystroke snapshots, trash, context menus, inline replay, walkthrough
 */
...
const els = {
    ...
    replaySpeedTrigger: $('#replaySpeedTrigger'),
    replaySpeedDropdown: $('#replaySpeedDropdown'),
...
function initEventListeners() {
    ...
    els.replaySpeedDropdown.querySelectorAll('.speed-option').forEach(option => {
        option.addEventListener('click', (e) => {
            ...
            els.replaySpeedDropdown.classList.remove('open');
        });
    });
